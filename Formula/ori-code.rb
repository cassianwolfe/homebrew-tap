class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.5.5/ori-code-0.5.5.tar.gz"
  sha256 "eee8b843a6d649b897822411d9e2f7bbb7fefc66e3babd54c4a704337078a4fd"
  license "MIT"
