class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.8.6/ori-code-0.8.6.tar.gz"
  sha256 "02cc9f198fc3f67752725337943c4a720c9854b7f2f20c9d1ea9e0f5a972660d"
  license "MIT"
