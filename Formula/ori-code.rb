class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.8.1/ori-code-0.8.1.tar.gz"
  sha256 "25b492c45abcbba0a9a2ceec185a9cdb535a345a58f5814834c067f810313eab"
  license "MIT"
