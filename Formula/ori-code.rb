class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.5.4/ori-code-0.5.4.tar.gz"
  sha256 "44529333541557c9f6d093543785cd979827b7e971a1d5f9e400785d748e6eba"
  license "MIT"
