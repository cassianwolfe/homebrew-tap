class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.3.2/ori-code-0.3.2.tar.gz"
  sha256 "e57cf4fab5d5be93bcad3bce1953cfb42c89884255e11e2ca2acb0fa4471639f"
  license "MIT"
