class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.9.37/ori-code-0.9.37.tar.gz"
  sha256 "db568c03e7a8e4700a3b61dcf442d8236bac3ca493d4ef014b301b40171f8429"
  license "MIT"
