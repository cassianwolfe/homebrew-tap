class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.4.8/ori-code-0.4.8.tar.gz"
  sha256 "9c71140aa5e7d7d80c0850db9aeb754ff4b0c0507819f40dd402782d156418e1"
  license "MIT"
