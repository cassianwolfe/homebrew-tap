class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.9.28/ori-code-0.9.28.tar.gz"
  sha256 "f55da77fa1f781b701264b050d5979027646a209ea5d779928d64bfb33eaffff"
  license "MIT"
