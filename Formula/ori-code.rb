class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.5.7/ori-code-0.5.7.tar.gz"
  sha256 "802e0facf31ecd6299d47bdd6f209c74be7a0320b48df8b93427eaddf5fc6c25"
  license "MIT"
