class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.9.0/ori-code-0.9.0.tar.gz"
  sha256 "dd1fbdf6b5cffa3a468a97bdd4e2df500daa3b5b7a21f29547cb8a9bfa376cb2"
  license "MIT"
